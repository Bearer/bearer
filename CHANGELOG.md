...
* **cli:** remove unnecessary dependencies ([c0f6bed](https://github.com/Bearer/bearer/commit/c0f6bed))
...
* **functions:** update TOAuth1Context ([#668](https://github.com/Bearer/bearer/issues/668)) ([559ca2f](https://github.com/Bearer/bearer/commit/559ca2f))
...
* **cli:** update last version ([#654](https://github.com/Bearer/bearer/issues/654)) ([d0246f8](https://github.com/Bearer/bearer/commit/d0246f8))





## [1.0.4](https://github.com/Bearer/bearer/compare/v1.0.3...v1.0.4) (2019-04-24)


### Bug Fixes

* **cli:** add support for local redirect ([b9356fa](https://github.com/Bearer/bearer/commit/b9356fa))
* **cli:** handle redirections from dev portal ([#653](https://github.com/Bearer/bearer/issues/653)) ([dd35dd2](https://github.com/Bearer/bearer/commit/dd35dd2))
* **cli:** render nicer page ([a1d83ca](https://github.com/Bearer/bearer/commit/a1d83ca))
...
* **cli:** remove extra logging ([f96d137](https://github.com/Bearer/bearer/commit/f96d137))
...
* **cli:** allow users to push when env variables are set ([#636](https://github.com/Bearer/bearer/issues/636)) ([ba897f0](https://github.com/Bearer/bearer/commit/ba897f0))
...
* add yarnlock ([12c6f76](https://github.com/Bearer/bearer/commit/12c6f76))
...
* **cli:** wording + integration list as default ([90c2375](https://github.com/Bearer/bearer/commit/90c2375))
...
* **react:** make peer deps not frozen ([4abaf3d](https://github.com/Bearer/bearer/commit/4abaf3d))
* **readme:** typo + harmonization ([db8ebe6](https://github.com/Bearer/bearer/commit/db8ebe6))
...
* typo ([f325558](https://github.com/Bearer/bearer/commit/f325558))
...
* **cli:** use the new url endpoints ([9973f66](https://github.com/Bearer/bearer/commit/9973f66))

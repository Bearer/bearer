...
Bearer CLI is written in [Go](https://www.go.dev), so you'll need golang v1.26 or greater installed. Installation instructions for your architecture can be found at [golang downloads page](https://go.dev/dl/).

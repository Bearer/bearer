...
The Bear Publishing example application will trigger policy breaches and output a full report. Here's a section of the output containing a breach snippet and the final summary:

...
s=document.querySelector("script[data-namespace='bearer-ui']");if(s){resourcesUrl=s.getAttribute('data-resources-url');}
...
(function(window, document, Context, namespace) {
  ...
  function initHostElement(plt, cmpMeta, HostElementConstructor, hydratedCssClass) {
    ...
    HostElementConstructor['s-hmr'] = function(hmrVersionId) {
      ...
      // forget the instance
            const instance = plt.instanceMap.get(this);
      if (instance) {
        plt.hostElementMap.delete(instance);
        plt.instanceMap.delete(this);
      }
      // request the bundle again
            plt.requestBundle(cmpMeta, this, hmrVersionId);
    };

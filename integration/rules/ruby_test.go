...
func TestRubyLangDeserializationOfUserInputDataflow(t *testing.T) {
	t.Parallel()
	runRulesTest("ruby/lang/deserialization_of_user_input", "dataflow", "ruby_lang_deserialization_of_user_input", t)
}
...
func TestRubyThirdPartiesGoogleAnalyticsSummary(t *testing.T) {
	t.Parallel()
	runRulesTest("ruby/third_parties/google_analytics", "summary", "ruby_third_parties_google_analytics", t)
}

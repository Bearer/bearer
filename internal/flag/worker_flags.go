...
var (
	ParentProcessIDFlag = WorkerFlagGroup.add(Flag{
		Name:       "parent-process-id",
		ConfigName: "worker.parent-process-id",
		Value:      -1,
	})
	PortFlag = WorkerFlagGroup.add(Flag{
		Name:       "port",
	...
	WorkerIDFlag = WorkerFlagGroup.add(Flag{
		Name:       "worker-id",
...
func (workerFlagGroup) SetOptions(options *Options, args []string) error {

...
static const TSParseActionEntry ts_parse_actions[] = {
    ...
    REDUCE(aux_sym_array_repeat1, 2),
    SHIFT_REPEAT(26),
    ...
    REDUCE(aux_sym__multiline_basic_string_repeat1, 2),
    SHIFT_REPEAT(39),
    ...
    REDUCE(sym__literal_string, 3),
    [243] = {.entry = {.count = 1, .reusable = true}},
    REDUCE(sym__literal_string, 2),
    [245] = {.entry = {.count = 1, .reusable = true}},
    REDUCE(sym__basic_string, 2),
    ...
    REDUCE(aux_sym__multiline_literal_string_repeat1, 2),
    SHIFT_REPEAT(60),
    ...
    REDUCE(aux_sym_array_repeat2, 3),
    [290] = {.entry = {.count = 1, .reusable = true}},
    REDUCE(sym__multiline_literal_string, 3),
    [292] = {.entry = {.count = 1, .reusable = true}},
    SHIFT(74),
    [294] = {.entry = {.count = 1, .reusable = true}},
    REDUCE(aux_sym_array_repeat2, 2),
    ...
    REDUCE(aux_sym__basic_string_repeat1, 2),
    SHIFT_REPEAT(72),
    ...
    REDUCE(aux_sym_array_repeat2, 4),
    [331] = {.entry = {.count = 1, .reusable = true}},
    REDUCE(sym_inline_table, 4, .production_id = 1),
    [333] = {.entry = {.count = 1, .reusable = true}},
    REDUCE(sym_integer, 1),
    [335] = {.entry = {.count = 1, .reusable = true}},
    REDUCE(sym_float, 1),
    [337] = {.entry = {.count = 1, .reusable = true}},
    REDUCE(sym_inline_table, 3, .production_id = 1),
    ...
    REDUCE(sym__multiline_basic_string, 2),
    [347] = {.entry = {.count = 1, .reusable = true}},
    REDUCE(sym__multiline_literal_string, 2),
    [349] = {.entry = {.count = 1, .reusable = true}},
    REDUCE(sym_inline_table, 2),
    [351] = {.entry = {.count = 1, .reusable = true}},
    REDUCE(sym_array, 3),
    [353] = {.entry = {.count = 1, .reusable = true}},
    REDUCE(sym__multiline_basic_string, 3),
    ...
    REDUCE(aux_sym_inline_table_repeat1, 2, .production_id = 1),
...
{
#endif
  void *tree_sitter_toml_1_external_scanner_create(void);
  void tree_sitter_toml_1_external_scanner_destroy(void *);
  bool tree_sitter_toml_1_external_scanner_scan(void *, TSLexer *, const bool *);
  unsigned tree_sitter_toml_1_external_scanner_serialize(void *, char *);
  void tree_sitter_toml_1_external_scanner_deserialize(void *, const char *, unsigned);

#ifdef _WIN32
#define extern __declspec(dllexport)
#endif

  extern const TSLanguage *tree_sitter_toml_1(void)
  {
    static const TSLanguage language = {
        ...
        .external_scanner = {
            ...
            tree_sitter_toml_1_external_scanner_create,
            tree_sitter_toml_1_external_scanner_destroy,
            tree_sitter_toml_1_external_scanner_scan,
            tree_sitter_toml_1_external_scanner_serialize,
            tree_sitter_toml_1_external_scanner_deserialize,
        },
    };
    return &language;
  }

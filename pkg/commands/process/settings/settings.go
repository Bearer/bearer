...
type RuleDefinition struct {
	...
	TriggerRuleOn       string            `mapstructure:"trigger_rule_on" json:"trigger_rule_on" yaml:"trigger_rule_on"`
	TriggerRuleOnAbsent string            `mapstructure:"trigger_rule_on_absent" json:"trigger_rule_on_absent" yaml:"trigger_rule_on_absent"`
}

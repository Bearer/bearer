critical:
    - rule_dsrid: DSR-1
      ...
      line_number: 6
      filename: pkg/commands/process/settings/rules/javascript/third_parties/open_telemetry/testdata/datatype_in_set_attribute.js
      category_groups:
        - PII
    ...
    - rule_dsrid: DSR-1
      ...
      parent_content: span.setAttribute("current-user", user.email)

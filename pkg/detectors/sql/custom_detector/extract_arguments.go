...
func (detector *Detector) ExtractArguments(node *parser.Node, idGenerator nodeid.Generator, filinfo *file.FileInfo, filepath *file.Path) (map[parser.NodeID]*schemadatatype.DataType, error) {
	if node == nil {
		return nil, nil
	}
